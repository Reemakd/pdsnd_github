...
def get_filters():
    ...
    while True:
      ...
      if city in ('chicago', 'new york', 'washington'):
        ...
        print("Please can you write only one city to see data for Chicago, New York or Washington?")
        continue
...
def user_stats(df):
    ...
    try:
      print('The most common year is... ',  df['Birth Year'].value_counts().idxmax(), '\n')
    except KeyError:
